...
\item {\em{FV}}: A configuration with the SE dynamical core replaced with the finite-volume core (section \ref{sec:cam-fv}{\color{red}{; experiment used to assess TE errors of a different dynamical core}}), and
